package com.xing.context;

import com.xing.event.ChannelWriteEvent;
import com.xing.handler.HandlerInitializer;
import com.xing.handler.InBoundHandler;
import com.xing.handler.OutBoundHandler;
...
public class ChannelHandlerContext {
     ...
     */
    public ChannelHandlerContext addHandler(Handler handler) {
    ...
    public void writeFlush(Object message) {
        ...
        workerManager.one(channel).submit(new ChannelWriteEvent(context, message));
    }
