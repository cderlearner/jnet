...
public class EasyLogger implements ILog {
    ...
    String format(Throwable t) {
        ...
        return LogConstants.LINE_SEPARATOR + expMessage;
    }
    ...
    public boolean isDebugEnable() {
        return LogLevel.DEBUG.compareTo(LogConfig.Logging.LEVEL) >= 0;
    }

    @Override
    public boolean isInfoEnable() {
        return LogLevel.INFO.compareTo(LogConfig.Logging.LEVEL) >= 0;
    }

    @Override
    public boolean isWarnEnable() {
        return LogLevel.WARN.compareTo(LogConfig.Logging.LEVEL) >= 0;
    }

    @Override
    public boolean isErrorEnable() {
        return LogLevel.ERROR.compareTo(LogConfig.Logging.LEVEL) >= 0;
    }
